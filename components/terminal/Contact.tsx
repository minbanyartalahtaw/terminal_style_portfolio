...
export function Contact() {
    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-2">
            ...
            >
                <div
                    className="p-4 rounded-none bg-[#2C2C2C] border-2 border-[#1A1A1A] shadow-[2px_2px_0px_#000000] h-full"
                >
                    <h3 className="text-lg font-semibold mb-3 text-slate-100">
                        Contact Information
                    </h3>
                    <div>
                        <div
                            className="flex items-center gap-3 p-2 rounded-none bg-[#3A3A3A] border-2 border-[#1A1A1A] shadow-[1px_1px_0px_#000000] hover:bg-[#4A4A4A] transition-colors"
                        >
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-slate-100 text-sm font-medium">{contactData.city}</p>
                            </div>
                        </div>
